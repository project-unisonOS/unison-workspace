...
Status: authoritative living threat model; Phase 4 bounded controls in review
...
| T-28 | Accessibility failure causes unsafe consent | Semantic decision and household controls expose invitation, removal, preview, cancellation, denial, status, and recovery without color-only meaning | Semantic parity, unambiguous recipient/data/action, cancellation and recovery in every modality | P4 candidate: labelled keyboard-native controls and live-region assertions pass; browser axe publication check pending |
