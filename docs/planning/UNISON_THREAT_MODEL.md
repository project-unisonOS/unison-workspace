...
| T-31 | Maintenance intelligence injection | Future advisory, forum, model, and release collectors will process attacker-controlled content | Sandboxed collectors, source registry, provenance/taint, claim corroboration, no external-content authority | P10: hostile-feed and prompt-injection corpus cannot create an executable plan |
| T-32 | Operational telemetry reveals private activity | Fine-grained workload and resource timing could expose another person's behavior | Content-free metrics, per-person aggregation, minimum device summaries, retention and access policy | P10: personal-content canaries remain absent and administrator views are non-oracular |
| T-33 | Privileged maintenance confused deputy | A planner or compromised collector could ask Lifecycle to execute an unsafe change | Typed operations, independent artifact/policy verification, exact grants, precondition hashes, checkpoints, health gates | P10: changed-plan, wrong-target, expired-grant, and untrusted-source execution deny |
| T-34 | Self-healing causes instability | Automated restarts, tuning, or updates could oscillate, loop, exhaust resources, or hide a failing system | Change budgets, cooldowns, circuit breakers, bounded retries, last-known-good, external watchdog | P10: restart-storm, resource-oscillation, interruption, and failed-health simulations contain damage |
| T-35 | Manipulated or commercially distorted recommendations | Popularity, benchmarks, sponsorship, affiliate content, or fabricated reports could cause poor software or hardware advice | Deterministic person-aligned ranking, commercial exclusion, source tiers, corroboration, local measurement, alternatives | P10: coordinated popularity and sponsored candidates cannot outrank locally evidenced compatible options |
