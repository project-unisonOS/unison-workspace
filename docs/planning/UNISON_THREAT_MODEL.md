...
| T-21 | Supply-chain compromise | Phase 9 locks one artifact owner, deterministic digest manifest, Ed25519-signed bundle/bootstrap verification, installation receipts, and threshold-signed update metadata; SBOM/provenance and public-download verification remain open | Pinned actions/digests, dependency locks, SBOM, signed provenance, image verification, reproducible builds | P9 bundle reproduction, tamper/inventory/trust-root rejection, and receipt reconciliation pass; P9.3 update metadata attacks pass; P9.5 must verify public artifacts |
