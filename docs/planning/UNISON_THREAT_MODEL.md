...
| T-21 | Supply-chain compromise | Phase 9 locks one artifact owner, deterministic digest manifest, and threshold-signed update metadata; SBOM/provenance and public-download verification remain open | Pinned actions/digests, dependency locks, SBOM, signed provenance, image verification, reproducible builds | P9.1 manifest reproduction passes; P9.3 replay/freeze/expiry/channel/hardware/corruption/rotation simulations pass; P9.5 must verify public artifacts |
