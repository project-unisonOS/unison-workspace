...
| T-16 | Insecure logs and traces | Governed audit stores identifiers, purposes, and metadata rather than memory content; broader legacy telemetry still needs Phase 3 review | Data-class-aware structured logging, payload references, per-person audit access, retention/deletion | P2 candidate: inspect/export paths are membership-bound and deletion redacts history; broader trace review remains P3 |
...
| T-25 | Shared infrastructure side channel | Content and existence boundaries use membership checks and uniform unavailable responses; timing/resource proof remains | Namespace isolation, cache partitioning, resource quotas, constant/error-safe responses where needed | P2 candidate: content/error isolation passes; timing and resource-abuse isolation remain P4 |
...
| T-27 | Coercive or manipulative optimization | Versioned personal charters prohibit third-party engagement, sponsored placement, and sale of personal context by default | Personal charter, ranking constraints, no sponsored/engagement signals, inspectable rationale | P2 candidate: charter origin/revision tests; workflow ranking review remains P7 |
