...
| T-21 | Supply-chain compromise | Phase 9 locks one artifact owner and a TUF update authority, but release inputs are not yet all immutable and verified | Pinned actions/digests, dependency locks, SBOM, signed provenance, image verification, reproducible builds | P9.0 ownership/trust contract validates; P9.1/P9.3/P9.5 must verify exact artifacts and public downloads |
