...
| 11. Private life operations and conversational data onboarding | In progress | LO-0 through LO-2 software gates passed 2026-07-25 | Canonical contracts, safety policies, synthetic corpus, encrypted universal intake, private source lifecycle, sandboxed read-only connections, PKCE, sync receipts, revocation, and accessible setup are implemented. Domain packages and pilot evidence remain. |
