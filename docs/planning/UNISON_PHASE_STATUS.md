...
| 9. Supported appliance release and lifecycle | In progress | Phase 9.0 passed 2026-07-23; CI-verifiable work continuing | Lifecycle authority is merged. Seventeen physical checks are explicitly deferred in the hardware ledger; CI, simulation, installer, update, and release work continues without treating those checks as passed. |
