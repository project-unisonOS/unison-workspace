...
| 9. Supported appliance release and lifecycle | In progress | Phase 9.0 candidate implemented 2026-07-23 | Lifecycle, artifact, runtime, update, maintenance, telemetry, and hardware-tier authority are locked; later gates remain. |
